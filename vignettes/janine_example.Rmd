...
```{r}
model <- out$models[[which.max(out$criteria$EBIC)]]
```
...
corrplot(model$net$Omega, is.corr = FALSE, tl.pos = "n", method = 'color', type = "upper", diag = FALSE, title = "Estimated precision")
corrplot(model$net$Sigma, is.corr = FALSE, tl.pos = "n", method = 'color', type = "upper", diag = FALSE, title = "Estimated variance")
```
