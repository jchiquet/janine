...
```{r janine}
fits <- janine(X, n_blocks = nbBlock, # alpha = 0.1,
...
```{r model selection}
model_EBIC  <- select_model(fits, "EBIC")
model_dense <- select_model(fits, "loglik")
```
...
plot(model_EBIC, type = "precision", title = "EBIC precision")
plot(model_EBIC, type = "covariance", title = "EBIC covariance")
plot(model_dense, type = "precision", title = "Best loglik precision")
plot(model_dense, type = "covariance", title = "Best loglik covariance")
```
