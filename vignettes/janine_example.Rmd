...
```{r janine}
out <- janine(X, n_blocks = nbBlock, # alpha = 0.25,
...
lines(out$criteria$penalty, out$criteria$objective, col = "green")
legend('topright', bty = "n", c("loglikelihood", "BIC", "EBIC", "pen-loglike"), col = c("black", "red", "blue", "green"), lty = c(1,1,1,1))
